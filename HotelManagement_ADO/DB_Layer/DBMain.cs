...
namespace HotelManagement_ADO.DB_Layer
{
    public class DBMain
    {
        ...
        public static string ConnStr = "Data Source=DESKTOP-EP66OTM\\MSSQLSERVER01;Initial Catalog=HotelManagementSystem;Integrated Security=False;User ID=sa;Password=123";
